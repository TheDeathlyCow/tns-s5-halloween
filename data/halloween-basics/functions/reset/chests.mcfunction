...
execute as @e[type=minecraft:armor_stand,tag=chest_north,tag=tier3_chest,distance=..500] at @s run setblock ~ ~ ~ minecraft:chest[facing=north]{LootTable:"halloween-basics:chests/tier3_chest"}
execute as @e[type=minecraft:armor_stand,tag=chest_north,tag=tier4_chest,distance=..500] at @s run setblock ~ ~ ~ minecraft:chest[facing=north]{LootTable:"halloween-basics:chests/tier4_chest"}
...
execute as @e[type=minecraft:armor_stand,tag=chest_south,tag=tier3_chest,distance=..500] at @s run setblock ~ ~ ~ minecraft:chest[facing=south]{LootTable:"halloween-basics:chests/tier3_chest"}
execute as @e[type=minecraft:armor_stand,tag=chest_south,tag=tier4_chest,distance=..500] at @s run setblock ~ ~ ~ minecraft:chest[facing=south]{LootTable:"halloween-basics:chests/tier4_chest"}
...
execute as @e[type=minecraft:armor_stand,tag=chest_west,tag=tier3_chest,distance=..500] at @s run setblock ~ ~ ~ minecraft:chest[facing=west]{LootTable:"halloween-basics:chests/tier3_chest"}
execute as @e[type=minecraft:armor_stand,tag=chest_west,tag=tier4_chest,distance=..500] at @s run setblock ~ ~ ~ minecraft:chest[facing=west]{LootTable:"halloween-basics:chests/tier4_chest"}
...
execute as @e[type=minecraft:armor_stand,tag=chest_east,tag=tier3_chest,distance=..500] at @s run setblock ~ ~ ~ minecraft:chest[facing=east]{LootTable:"halloween-basics:chests/tier3_chest"}
execute as @e[type=minecraft:armor_stand,tag=chest_east,tag=tier4_chest,distance=..500] at @s run setblock ~ ~ ~ minecraft:chest[facing=east]{LootTable:"halloween-basics:chests/tier4_chest"}