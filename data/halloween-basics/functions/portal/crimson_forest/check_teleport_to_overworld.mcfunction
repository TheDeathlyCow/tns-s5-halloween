execute at @e[type=minecraft:armor_stand,tag=crimson_portal_nether] as @a[dx=5,dz=0,dy=10] run function halloween-basics:portal/crimson_forest/confirm_exit
