...
clear @s minecraft:blaze_powder{display:{Name:'{"italic":false,"color":"gold","text":"Magma Essence"}'},magmaEssence:1b,Enchantments:[{id:'minecraft:fire_aspect',lvl:3s}]}
execute if entity @s[advancements={halloween-basics:defeat_basalt_boss=false}] run clear @s minecraft:gold_nugget{display:{Name:'{"italic":false,"color":"gold","text":"Pirate Booty"}'},Enchantments:[{id:"minecraft:looting",lvl:3s}],booty:1b}
