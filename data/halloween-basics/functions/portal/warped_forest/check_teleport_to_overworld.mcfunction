execute at @e[type=minecraft:armor_stand,tag=warped_portal_nether] as @e[type=minecraft:player,dz=3,dy=5] if entity @s run function halloween-basics:portal/warped_forest/confirm_exit
