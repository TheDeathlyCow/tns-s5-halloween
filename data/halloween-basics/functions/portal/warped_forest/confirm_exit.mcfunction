...
execute if entity @s[advancements={halloween-basics:defeat_warped_boss=true}] run tp @s ~3 ~ ~

execute if score numWarpedPlayers wrpdPlyrsCnt matches ..1 run execute unless entity @s[advancements={halloween-basics:defeat_warped_boss=true}] run tp @s ~3 ~ ~
