...
function halloween-basics:portal/nether_castle/check_teleport_to_overworld
function halloween-basics:portal/nether_castle/check_teleport_to_nether
...
execute if score numBasaltPlayers bsltPlyrsCnt matches ..-1 run scoreboard players set numBasaltPlayers bsltPlyrsCnt 0
execute if score numValleyPlayers svlyPlyrsCnt matches ..-1 run scoreboard players set numValleyPlayers svlyPlyrsCnt 0
