...
execute if entity @s[advancements={halloween-basics:defeat_castle=true}] run tp @s ~-7 ~-1 ~2.5

execute if score numValleyPlayers svlyPlyrsCnt matches ..1 run execute unless entity @s[advancements={halloween-basics:defeat_castle=true}] run tp @s ~-7 ~-1 ~2.5
