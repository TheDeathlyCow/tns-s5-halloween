...
# ===== svly boss stuff =====
execute if score numValleyPlayers svlyPlyrsCnt matches 1.. run function halloween-bosses:nether_castle/tick

# svly speed run stuff 
scoreboard players add @a[tag=ValleyParty] svlyTime 1
