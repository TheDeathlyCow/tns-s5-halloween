...
execute if score captainHealth seasHP matches ..180 as @e[tag=seas_boss_stage2_spawn] at @s run function halloween-bosses:lava_seas/fight/next_stage/stage_2