...
TEMPLATE_FRONT = """execute as @e[type=minecraft:armor_stand,tag=dir_dispenser] at @s if block ~ ~ ~ minecraft:dropper[facing=east]{Items:[{Slot:"""
...
def generate_direction():
    ...
    for i in range(0, 9):
        line = TEMPLATE_FRONT + str(i) + DIRECTION_TEMPLATE_BACK + '\n'
        print(line)
        outfile.write(line)
...
def generate_time():
    ...
    for i in range(0, 9):
        line = TEMPLATE_FRONT + str(i) + TIME_TEMPLATE_BACK + '\n'
        print(line)
        outfile.write(line)
