...
execute if score kingHealth cmsnHP matches ..300 run execute if score cmsnCurrStage cmsnBssStg matches 0 run function halloween-bosses:crimson_forest/fight/next_stage
execute if score kingHealth cmsnHP matches ..150 run execute if score cmsnCurrStage cmsnBssStg matches 1 run function halloween-bosses:crimson_forest/fight/next_stage
execute if score kingHealth cmsnHP matches ..75 run execute if score cmsnCurrStage cmsnBssStg matches 2 run function halloween-bosses:crimson_forest/fight/next_stage
