...
execute as @e[type=minecraft:armor_stand,tag=wprd_boss_first_pos] at @s if entity @a[tag=WarpedParty,distance=..10] run function halloween-bosses:warped_forest/start_fight
