...
execute unless entity @e[tag=wrpdShardTwo] as @e[type=minecraft:armor_stand,tag=wprd_boss_third_pos] at @s run execute if score currWarpedStage WrpdStge matches 2 run function halloween-bosses:warped_forest/fight/begin_stage_3
