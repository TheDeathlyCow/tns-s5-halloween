...
tellraw @a[tag=WarpedParty] {"text":"This gate will close in 10 seconds...","color":"aqua"}
schedule function halloween-bosses:warped_forest/countdown/five_seconds 5s