teleport @a[tag=SvlyWrpd] @e[tag=svly_crown_entrance,limit=1]

title @a[tag=SvlyWrpd] title {"text":"The Warped Portals","color":"dark_aqua","bold":true}
title @a[tag=SvlyWrpd] subtitle {"text":"A crown of wood","color":"aqua"}
tellraw @a[tag=SvlyWrpd] {"text":"A crown of wood...","color":"aqua"}
