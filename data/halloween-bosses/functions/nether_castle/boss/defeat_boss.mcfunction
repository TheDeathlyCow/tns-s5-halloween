...
tellraw @a[tag=ValleyParty] ["",{"text":"Click ","color":"aqua"},{"text":"here","underlined":true,"color":"dark_purple","clickEvent":{"action":"run_command","value":"/trigger svlyCredits set 1"}},{"text":" when you are ready to leave.","color":"aqua"}]
