teleport @a[tag=SvlyWrpd] @e[tag=svly_burn_entrance,limit=1]

title @a[tag=SvlyWrpd] title {"text":"The Warped Portals","color":"dark_aqua","bold":true}
title @a[tag=SvlyWrpd] subtitle {"text":"Where the souls of the dammed burn brightest","color":"aqua"}
tellraw @a[tag=SvlyWrpd] {"text":"Where the souls of the dammed burn brightest...","color":"aqua"}
